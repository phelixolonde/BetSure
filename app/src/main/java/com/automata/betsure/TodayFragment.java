...
public class TodayFragment extends Fragment implements SearchView.OnQueryTextListener, SwipeRefreshLayout.OnRefreshListener {

    private static final String TAG ="FACEBOOK_ADS" ;
    View v;
    RecyclerView recyclerView;
    private String urlJsonObj = "https://football-prediction-api.p.mashape.com/api/v1/predictions";
