...
public class YesterdayFragment extends Fragment implements SearchView.OnQueryTextListener, SwipeRefreshLayout.OnRefreshListener {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < sortedJsonArray.length(); i++) {
                        ...
                        model.result=jsonobject.getString("result");
